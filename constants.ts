...
export const NATURE_OF_QUESTIONS = [
    { label: "Very Simple", value: 1 },
...
export const LESSON_CHECKLIST_CONFIG = {
    B1: { title: "Objectives Alignment", items: ["Specific", "Measurable", "Achievable", "Relevant", "Time-bound", "Linked to Curriculum"] },
    B2: { title: "Content Mastery", items: ["Accurate Facts", "Scope Appropriate", "Key Concepts Identified", "Sequencing Logical"] },
    B3: { title: "Teaching Strategies (Plan)", items: ["Learner-Centered", "Variety of Methods", "Questioning Techniques Planned", "Group Work Planned"] },
    B4: { title: "Lesson Structure (Plan)", items: ["Introduction/RPK", "Main Activities", "Plenary/Closure", "Time Allocation"] },
    B5: { title: "TLM Preparation", items: ["Relevant Resources Listed", "Creative use of local materials", "Digital Integration"] },
    B6: { title: "Assessment (Plan)", items: ["Core Points", "Evaluation Questions", "Homework/Assignment"] },
    B7: { title: "Language & Clarity", items: ["Clear Instructions", "Appropriate Vocabulary", "Legible Handwriting/Typing"] },
    B8: { title: "Inclusivity (Plan)", items: ["Differentiation Strategy", "Support for Special Needs", "Gender Sensitivity"] },
    B9: { title: "Teacher Reflection", items: ["Section provided for reflection", "Previous remarks addressed"] },

    C1: { title: "Preparation & Environment", items: ["Punctuality", "Lesson Plan Available", "TLMs Ready", "Class Organization"] },
    C2: { title: "Lesson Delivery", items: ["Introduction Effective", "Subject Mastery", "Voice Projection", "Teacher Confidence"] },
    C3: { title: "Class Management", items: ["Discipline Maintained", "Time Management", "Student Engagement", "Safe Environment"] },
    C4: { title: "Methodology Application", items: ["Use of RPK", "Student Participation", "Effective Questioning", "Critical Thinking Promoted"] },
    C5: { title: "Inclusivity (Observed)", items: ["Attention to all learners", "Gender Balance in questions", "Support for struggling learners"] },
    C6: { title: "Assessment (Observed)", items: ["Check for understanding", "Feedback given", "Student corrections managed"] },
    C7: { title: "Conclusion", items: ["Lesson summarized", "Evaluation conducted", "Home work assigned", "Closing effective"] }
};
